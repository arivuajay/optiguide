...
class PublicityAds extends CActiveRecord {
    ...
    public $archivecat, $publicityModules, $regions, $section;
    ...
    public function rules() {
        ...
        return array(
            array('TITRE,LIEN_URL,archivecat,ID_FICHIER', 'required'),
...
//            ),
    ...
    public function checknotempty($attribute_name, $params) {
        ...
        if ($this->PRIORITE == 1 && $this->NB_IMPRESSIONS == '') {
            $this->addError('NB_IMPRESSIONS', "maximum impressions ne peut être vide.");
            return false;
        }
        return true;
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'ID_POSITION' => Myclass::t('Position'),
