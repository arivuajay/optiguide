...
class ClientCategory extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('cat_type_id, cat_name', 'required'),
            array('cat_name','unique', 'message'=>'Category name already exists.'),
    ...
    public function relations() {
        ...
        return array(
            'catType' => array(self::BELONGS_TO, 'ClientCategoryTypes', 'cat_type_id'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'cat_type_id' => Myclass::t('Category Type'),
            'cat_name' => Myclass::t('Category Name'),
        );
    }
