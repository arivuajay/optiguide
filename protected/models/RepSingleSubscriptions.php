...
class RepSingleSubscriptions extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('rep_credential_id, rep_admin_subscription_id, rep_subscription_type_id', 'numerical', 'integerOnly' => true),
            array('rep_single_price, rep_single_tax, rep_single_total', 'numerical'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('rep_single_subscription_id, rep_credential_id, rep_admin_subscription_id, rep_subscription_type_id, rep_single_price, rep_single_tax, rep_single_total, rep_single_subscription_start, rep_single_subscription_end, created_at, modified_at', 'safe', 'on' => 'search'),
        );
    }
