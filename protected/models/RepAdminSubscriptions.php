...
class RepAdminSubscriptions extends CActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'rep_admin_per_account_price' => Myclass::t('Per Account Price'),
            'rep_admin_no_of_months' => Myclass::t('No Of Months'),
            'rep_admin_total_month_price' => Myclass::t('Total Month Price'),
            'offer_in_percentage' => Myclass::t('Offer In Percentage'),
            'offer_price' => Myclass::t('Offer Price'),
            'rep_admin_total_price' => Myclass::t('Total Price'),
            'rep_admin_tax' => Myclass::t('Tax'),
            'rep_admin_grand_total' => Myclass::t('Grand Total'),
            'rep_admin_subscription_start' => Myclass::t('Subscription Start'),
            'rep_admin_subscription_end' => Myclass::t('Subscription End'),
