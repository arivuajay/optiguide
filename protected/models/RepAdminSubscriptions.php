...
class RepAdminSubscriptions extends CActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'no_of_accounts_purchased' => Myclass::t('OR558', '', 'or'),
            'rep_admin_old_active_accounts' => Myclass::t('OR667', '', 'or'),
            'no_of_accounts_used' => Myclass::t('OR668', '', 'or'),
            'no_of_accounts_remaining' => Myclass::t('OR669', '', 'or'),
            'rep_admin_per_account_price' => Myclass::t('OR670', '', 'or'),
            'rep_admin_no_of_months' => Myclass::t('OR671', '', 'or'),
            'rep_admin_total_month_price' => Myclass::t('OR672', '', 'or'),
            'offer_in_percentage' => Myclass::t('OR673', '', 'or'),
            'offer_price' => Myclass::t('OR563', '', 'or'),
            'rep_admin_total_price' => Myclass::t('OR674', '', 'or'),
            'rep_admin_tax' => Myclass::t('OR540', '', 'or'),
            'rep_admin_grand_total' => Myclass::t('OR541', '', 'or'),
            'rep_admin_subscription_start' => Myclass::t('OR577', '', 'or'),
            'rep_admin_subscription_end' => Myclass::t('OR578', '', 'or'),
