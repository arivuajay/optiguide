...
class ClientProfiles extends CActiveRecord
{
	...
	public function attributeLabels()
	{
            return array(
                ...
                'ID_CLIENT'=> Myclass::t('APP3'),
                'name' => Myclass::t('OG233'),
                'company' => Myclass::t('OG234'),
                'job_title' => Myclass::t('OG235'),
                'member_type' => Myclass::t('OG102'),
                'cat_type_id' => Myclass::t('OG236'),
                'category' => Myclass::t('OG237'),
                'address' => Myclass::t('APP66'),
                'local_number' => Myclass::t('OG238'),
                'country' => Myclass::t('APP68'),
                'region' => Myclass::t('Province'),
                'ville' => Myclass::t('APP70'),
                'phonenumber1' => Myclass::t('APP72'),
                'phonenumber2' => Myclass::t('APP72')." 2",
                'phonenumber3' => Myclass::t('APP72')." 3",
                'mobile_number' => Myclass::t('OG241'),
                'tollfree_number' => Myclass::t('APP74'),
                'fax' => Myclass::t('APP73'),
                'email' => Myclass::t('APP75'),
                'site_address' => Myclass::t('APP76'),
                'subscription' => Myclass::t('OG240'),
