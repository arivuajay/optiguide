...
/**
 * This is the model class for table "supplier_subscription_price".
 *
 * The followings are the available columns in table 'supplier_subscription_price':
 * @property integer $id
 * @property double $profile_price
 * @property double $profile_logo_price
 */
class SupplierSubscriptionPrice extends CActiveRecord
{
	/**
	...
	{
		return 'supplier_subscription_price';
	}
	 ...
	 * @return SupplierSubscriptionPrice the static model class
	 */
