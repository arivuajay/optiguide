...
class RetailerDirectory extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'COMPAGNIE' => Myclass::t('Nom du magasin'),
			'ID_VILLE' => Myclass::t('Ville'),
			'ADRESSE' => Myclass::t('Adresse'),
			'ADRESSE2' => Myclass::t('Adresse (suite)'),
			'CODE_POSTAL' => Myclass::t('Code Postal'),
			'TELEPHONE' => Myclass::t('Telephone #1'),
			'TELEPHONE2' => Myclass::t('Telephone #2'),
			'TELECOPIEUR' => Myclass::t('Telecopieur #1'),
			'TELECOPIEUR2' => Myclass::t('Telecopieur2'),
			'URL' => Myclass::t('Adresse web'),
			...
			'CATEGORY_1' => Myclass::t('Opticiens'),
			'CATEGORY_2' => Myclass::t('Optométristes'),
			'CATEGORY_3' => Myclass::t('Ophtalmologistes'),
			'CATEGORY_4' => Myclass::t('Lunettes solaires seulement'),
			'CATEGORY_5' => Myclass::t('Boutique'),    
                        'Categories' => Myclass::t('Catégories'),
                        'region'     => Myclass::t('Région'),
