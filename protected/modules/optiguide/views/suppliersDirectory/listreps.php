    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
        <div class="inner-container"> 
            ...
            <div class="forms-cont"> 
                <div class="forms-heading"><i class="fa fa-users"></i> <?php echo Myclass::t('OGO174', '', 'og');?></div>
                <div class="row"> 
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <table class="table table-bordered bckrnd">
                            <tr>   
                                <th><input type="checkbox" class="simple" name="checkall" id="selecctall"></th>
                                <th> <?php echo Myclass::t('OGO175', '', 'og'); ?> </th>       
                            ...
                            if (!empty($results)) {
                                ...
                                ?>
                                <tr><td colspan="2">  <?php echo Myclass::t('OGO176', '', 'og'); ?> .</td></tr>
                            <?php }
                            ?>                         
                        </table>
                    </div>
...
<?php
$msgconfirm = Myclass::t('OGO177', '', 'og');
$delconfirm = Myclass::t('OGO178', '', 'og');
$js = <<< EOD
...
$("#suppliers-directory-form").submit(function() {
   ...
   var checked = $(this).find("input[name='repid[]']:checked").length;
...
EOD;
Yii::app()->clientScript->registerScript('_form_listreps', $js);
?>