<div class="search-bg"> 
    ...
    $form = $this->beginWidget('CActiveForm', array(
        'id' => 'search-form',
        'method' => 'get',
        'action' => array('/optiguide/groupInformation/index'),
    ...
    $category_list = CHtml::listData($categories, 'ID_CATEGORIE', 'CATEGORIE_' . Yii::app()->session['language'])
    ?>
...
<?php
$ajaxRegionUrl = Yii::app()->createUrl('/optiguide/groupInformation/getregions');
$js = <<< EOD
