...
class ProfessionalDirectoryController extends ORController {
    ...
    public function actionView($id) {
        ...
        $prof_query = Yii::app()->db->createCommand() //this query contains all the data
                ->select('rs.* ,ru.COURRIEL, ru.ID_UTILISATEUR , ru.NOM_UTILISATEUR , TYPE_SPECIALISTE_' . $this->lang . ' ,  NOM_VILLE ,  NOM_REGION_' . $this->lang . ' , ABREVIATION_' . $this->lang . ' ,  NOM_PAYS_' . $this->lang . '')
