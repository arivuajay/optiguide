...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    <div class="cate-bg"> 
        <div class="cate-heading cate-heading2">  <i class="fa fa-pencil"></i>  My Notes  <?php echo (!empty($model_notes))?CHtml::link(Myclass::t('OG038', '', 'og'), array('/optirep/repNotes'), array('class' => 'topviewall')):''; ?></div>
        <?php
        if (!empty($model_notes)) {
            ...
            $no_notes_str = "<p class='fav_message'>You have no notes right now.";
            if ($urole == "admin") {
                $no_notes_str .= CHtml::link("Click", array('/optirep/repNotes/create')) . " here to add your notes.";
            }
            $no_notes_str .= "</p>";
            echo $no_notes_str;
        }
