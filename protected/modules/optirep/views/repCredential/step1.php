...
//                    $checked = 'checked';
        ...
        {
           $rep_subscription_name    = $repSubscriptionType['rep_subscription_name_fr'];  
           $rep_subscription_description = $repSubscriptionType['rep_subscription_description_fr'];
        }else{
           $rep_subscription_name    = $repSubscriptionType['rep_subscription_name'];  
           $rep_subscription_description = $repSubscriptionType['rep_subscription_description'];
        }
            ?>
                    ...
                    <?php // echo $form->radioButton($model, 'subscription_type_id', array('value' => $repSubscriptionType['rep_subscription_type_id'], 'uncheckValue' => null, 'class' => 'subscription_types', 'id' => $repSubsTypeId, 'checked' => $checked)); ?>
                        ...
                        <div class="subscription-cont <?php echo $active_class; ?>">
                            <div class="subscription-heading subscription-heading<?php echo $repSubsTypeId + 1 ?>">  
                                <?php echo $rep_subscription_name; ?> 
                            </div>
                            <div class="subscription-txt"> 
                                <p> 
                                    ...
                                    <?php echo Myclass::t('OR751', '', 'or'); ?>  <br/>
                                    +  <br/>
                                    <?php echo $rep_subscription_description; ?>
                                </p>
                                <p>
