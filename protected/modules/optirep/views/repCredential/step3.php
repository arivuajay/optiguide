...
//                                        ), '<i class="fa fa-check-circle"></i>' . ' Pay Now');
                   ...
                   <?php
                    ...
                    $mode          = $response['mode'];
                    $invoice_id    = $response['tempid'];
                    
                   ?>
                   <div style="border: 1px dashed; margin-left:40px; width:492px; height:567px;">
                        <iframe src='https://payflowlink.paypal.com?SECURETOKEN=<?php echo $securetoken;?>&SECURETOKENID=<?php echo $securetokenid;?>&MODE=<?php echo $mode?>&PARMLIST="NVNUM=<?php echo $invoice_id?>"' width='490' height='565' border='0' frameborder='0' scrolling='no' allowtransparency='true'>\n</iframe>
                    </div>
