...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ad1">
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 steps-cont <?php echo $active_class_step1 ?>"> 
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 steps-cont <?php echo $active_class_step2 ?>"> 
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 steps-cont <?php echo $active_class_step3 ?>">  
