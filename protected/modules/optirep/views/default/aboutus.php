...
<!--                    <p>With Opti-Rep, you can finally keep all the information you need within reach. Find all the suppliers, brands and professionals’ details and contact information faster and easier than ever before. Our key-indicators and statistics allow you to create customized strategy for your ECP’s, You will have all in hands to assist your clients in achieving maximum sales and growth in their specific market; Perfect to help you and your clients meet your own objectives!</p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8"> 
                    <ul>
                        <li>A list of optical distributors available with their coordinates. A profile is displayed when the supplier is an <a href="http://www.opti-guide.com/">Opti-Guide</a> member</li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b>Calendar: </b>Find all national and international optical events with relevant information. Accessible directly on the account home page.
                    </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b>News:</b> Access to all the Canadian and international news concerning the optical industry, as well as important updates about optical retail stores and professionals. Accessible directly on the account home page.
                    </p>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b>My Notes:</b> Add, modify or delete notes attributed to colleagues, suppliers and clients. Amend professional profiles. Accessible directly on the account home page.
                    </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p><b>Favourites:</b> A personalized list of favourite optical stores and professionals to keep handy for rapid referral and follow-ups.</p>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <p><b>Messages:</b> An interactive internal messaging service to reach actual and potential clients (professionals & optical retailers).</p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p><b>Statistics:</b> Current stats on the Canadian optical industry, organized by city, and province (extra monthly fee applicable)</p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4">
                    ...
                    <div class="clearfix"></div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <p><b>Classified:</b> Optical professionals can post classified ads, at no cost, to promote the sale of their office, equipment or services. A good way for sales representatives to stay informed of upcoming changes in the market.</p>
                    <p><b>Miscellaneous:</b> Includes other players in the optical industry such as associations,foundations, organizations, institutions, governments, and more.</p>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="clearfix"></div>
                    <p>Opti-Rep.com is an interactive website adapted to all types of devices: desktop computers, laptops, smart phones and tablets. No need to install an application for usage.</p>
                     <h4> <?php echo Myclass::t('OR762', '', 'or') ?> </h4> 
                    <div class="clearfix"></div>
                    <p>Membership options per month, six months or the entire year. Renewal available by confirmation and direct payment directly in the online account.</p>
...
<!--                    <p>Opti-Rep regroupe toutes les informations dont vous avez besoin à portée de main.</p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b>Calendrier: </b> Tous les évènements nationaux et internationaux de l’optique et informations utiles à leur sujet. Accessible directement en page d’accueil du compte.
                    </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                    <?php  $image = CHtml::image("{$this->themeUrl}/images/Calendar.png", 'optirep'); echo CHtml::link($image, array('/optirep'));?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b>Nouvelles:</b>  Accès à toutes les nouvelles de l’industrie de l’optique au Canada et l’étranger ainsi qu’aux mises à jour importantes des bureaux d’optiques et professionnels de la vue. Accessible directement en page d’accueil du compte.
                    </p>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b> Mes Notes :</b> Ajouter, modifier, supprimer des notes attribuées à des profils de détaillants et professionnels. Disponible dans le compte du représentant ainsi que sur la page d’accueil.
                    </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                    <?php  $image = CHtml::image("{$this->themeUrl}/images/Notes.png", 'optirep'); echo CHtml::link($image, array('/optirep'));?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b>Favoris:</b>  Une liste personnalisable des comptes détaillants et professionnels afin de les garder en mémoire et effectuer un suivi plus rapidement.
                    </p>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <p>
                        <b>Messages:</b> Un système de messagerie interne pour communiquer avec les actuels et futurs.
                    </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-8">
                    <p>
                        <b>Statistiques:</b> Une ressource qui regorge de données très utiles sur l’industrie l’optique au Canada présenté de façon dynamique et réparties par province et par ville. (Des frais mensuels supplémentaires s’appliquent)
                    </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4">
                        <?php  $image = CHtml::image("{$this->themeUrl}/images/Stats.png", 'optirep'); echo CHtml::link($image, array('/optirep'));?>
                    ...
                    <div class="clearfix"></div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <p><b>Petites Annonces :</b>  Une section permettant aux professionnels de la vue gratuitement des petites annonces pour vendre leur boutique, de l’équipement ou un service, un bon moyen pour les représentants de se tenir informé des changements à venir.</p>
                    <p><b>Divers :</b>Une liste de tous les intervenants du monde l’optique tels que les fondations, établissements d’enseignement et bien plus encore.          
                    </p>
                    </div>
                    <div class="clearfix"></div>
                    <h4> <?php echo Myclass::t('OR759', '', 'or') ?> </h4> 
                    ...
                    <ul>
                     ...
                     <h4> <?php echo Myclass::t('OR761', '', 'or') ?> </h4> 
                    <div class="clearfix"></div>
                    <p> Opti-Rep.com est un site web interactif qui s’adapte à tous types d’appareils : ordinateur bureau, ordinateur portable, tablettes, téléphone intelligent. Il n’est pas nécessaire d’installer une application pour l’utiliser.</p>
                     <h4> <?php echo Myclass::t('OR762', '', 'or') ?> </h4> 
                    <div class="clearfix"></div>
                    <p>Options d’abonnement au mois, aux 6 mois ou à l’année. Renouvellement disponible par confirmation et paiement directement dans le compte en ligne. </p>
                    <?php } ?>
                </div>
            </div>
        </div>
