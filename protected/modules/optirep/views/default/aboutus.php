    ...
    <div class="cate-bg user-right">
        <div class="row"> 
                    ...
                    <div class="search-list">
                        <div class="news-thumbs news-details">                            
                            <?php if (Yii::app()->language == 'en') { ?>
                              <h3>The Opti-rep is even more interactive!</h3>
                             <h4 class="new-features">  <?php echo "NEW FEATURES"; ?> </h4> 
                              
                                <div class="clearfix"></div>
                                <p><b>New Interactive Calendar</b> </p>
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-highlight.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                    <ul>
                                        <li>View in an instant all your appointments or reminders per date in an interactive calendar via MY NOTES section. </li>
                                        <li>Click on the highlighted dates to retrieve appointments or reminders.</li>
                                        <li>Click on View All to see all your notes.</li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div> 
                                <p><b>New search engine in MY NOTES</b></p>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                     <ul>
                                         <li>Search by Client name or by Reminder date.</li>
                                     </ul>
                                 </div>   
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-search.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>                                
                                <div class="clearfix"></div> 
                                
                                <p><b>New Alert system for Notifications</b></p>                                
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-notification.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                     <ul>
                                         <li>Add appointments or reminders to your calendar via MY NOTES module and receive your daily alerts by email.</li>
                                     </ul>
                                 </div>  
                                <div class="clearfix"></div> 
                            <?php }else{?>
                                <h3>L’OPTI-REP EST ENCORE PLUS INTERACTIF!</h3>
                                <h4 class="new-features">  <?php echo "NOUVELLES FONCTIONNALITÉS"; ?> </h4> 
                                
                                <div class="clearfix"></div>
                                <p><b>Nouveau calendrier interactif</b> </p>
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-highlight-fr.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                    <ul>
                                        <li>Voyez d’un seul coup d’œil tous vos rendez-vous ou rappels par date dans un calendrier interactif via la section MES NOTES. </li>
                                        <li>Cliquez sur les dates surlignées pour récupérer vos rendez-vous ou vos rappels.</li>
                                        <li>Cliquez sur Tout Voir pour voir toutes vos notes.</li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div> 
                                <p><b>Nouveau module de recherche dans la section MES NOTES</b></p>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                     <ul>
                                         <li>Recherchez par nom de client ou par dates de rappel.</li>
                                     </ul>
                                 </div>   
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-search-fr.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>                                
                                <div class="clearfix"></div> 
                                
                                <p><b>Nouveau système d’alerte des Notifications</b></p>                                
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-notification-fr.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                     <ul>
                                         <li>Ajoutez des rendez-vous ou des rappels dans votre calendrier via le module MES NOTES et recevez vos alertes journalières par courriel.</li>
                                     </ul>
                                 </div>  
                                <div class="clearfix"></div> 
                             <?php   
            ...
            <!--                    <p>With Opti-Rep, you can finally keep all the information you need within reach. Find all the suppliers, brands and professionals’ details and contact information faster and easier than ever before. Our key-indicators and statistics allow you to create customized strategy for your ECP’s, You will have all in hands to assist your clients in achieving maximum sales and growth in their specific market; Perfect to help you and your clients meet your own objectives!</p>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Retailers.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                    <ul>
                                        ...
                                        <li>Geolocation: map display with possibility to create an itinerary and display directions</li>
                                        <li>A versatile profile record: add an optical store to your favorites, send an email, report a change, add notes</li>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                    <ul>
                                        ...
                                        <li>Geolocation: map display with possibility to create an itinerary and display directions</li>
                                        <li>A versatile profile record: add a professional to your favorites, send an email, report a change, add notes</li>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Professionals.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Supplier.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/calendar-en.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/News.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-en.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Favorites.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4">
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/user-subscription-en.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4 last-pag">
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Rep profile.jpg", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                            ...
                            <?php } else { ?>
                                ...
                                <p><b>Recherche de boutique d’optique</b> </p>
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Retailers French.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                    <ul>
                                        ...
                                        <li>Une recherche facilitée par la sélection d’un ou plusieurs critères : Nom, type de boutique, regroupement, catégorie professionnelle, ville, province et code postal</li>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                    <ul>
                                        ...
                                        <li>Une recherche facilitée par la sélection d’un ou plusieurs critères : Nom, type de professionnel, ville, province et code postal</li>
                                        <li>Géolocalisation : affichage d’une carte avec possibilité de créer un visualisable avec instructions routières</li>
                                        ...
                                        <li>Interface de données référentielles : visualiser la(les) boutique(s) dans laquelle travaille le professionnel sélectionné et cliquez pour accéder au profil de la boutique</li>
                                    </ul>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Professionals French.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Suppliers French.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8"> 
                                    <ul>
                                        <li>Une liste des fournisseurs de l’optique avec possibilité de voir leurs coordonnées. Un profil détaillé s’affichera si le fournisseur est membre d’<a href="http://www.opti-guide.com/">Opti-Guide.com</a></li>
                                        <li>Une recherche facilitée par la sélection d’un ou plusieurs critères : Nom de l’entreprise, type de fournisseur, marque et catégorie de produits et services</li>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                                <p><b>Calendrier</b></p>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                    Tous les évènements nationaux et internationaux de l’optique et renseignements utiles à leur sujet. Accessible directement en page d’accueil du compte.
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/calendar-fr.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/News French.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                ...
                                <p><b>Mes Notes</b></p>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                    Ajouter, modifier, supprimer des notes attribuées à des profils de détaillants et professionnels. Accessible dans le compte du représentant ainsi que sur la page d’accueil.
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/notes-fr.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Favorites French.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                    Une ressource qui regorge de données très utiles sur l’industrie l’optique au Canada présentées de façon dynamique et réparties par province et par ville. (Des frais mensuels supplémentaires s’appliquent)
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4">
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/user-subscription-fr.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4 last-pag">
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Rep profile French.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-8">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 last-pag">
                                    <ul>
                                        ...
                                        <li>Suivi des actions de chaque représentant : connexion et profil</li>
                                    </ul>
                                </div>
                                <h4> <?php echo Myclass::t('OR761', '', 'or') ?> </h4> 
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 last-pag">
    ...
    <div class="cate-bg user-right">
        <div class="row"> 
                            ...
                            <?php if (Yii::app()->language == 'en') { ?>
                             ...
                             <h4 class="new-features">  <?php echo "NEW FEATURES"; ?> </h4> 
                                ...
                                <p><b>New search engine in MY NOTES</b></p>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                     <ul>
                                         <li>Search by Client name or by Reminder dates.</li>
                                     </ul>
                                 </div>   
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                    <?php
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                 ...
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                     <ul>
                                         <li>Ad appointments or reminders to your calendar via MY NOTES module and receive your daily alerts by email.</li>
                                     </ul>
                                 </div>  
                                <div class="clearfix"></div> 
                            <?php }else{?>
                                <h3>L’OPTI-REP EST ENCORE PLUS INTÉRACTIF!</h3>
                                <h4 class="new-features">  <?php echo "NOUVELLES FONCTIONNALITÉS"; ?> </h4> 
                                ...
                                <p><b>Nouveau module de recherche dans la section MES NOTES</b></p>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                     <ul>
                                         <li>Recherchez par nom de clients ou par dates de rappels.</li>
                                     </ul>
                                 </div>   
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> 
                                    <?php
            ...
            <!--                    <p>With Opti-Rep, you can finally keep all the information you need within reach. Find all the suppliers, brands and professionals’ details and contact information faster and easier than ever before. Our key-indicators and statistics allow you to create customized strategy for your ECP’s, You will have all in hands to assist your clients in achieving maximum sales and growth in their specific market; Perfect to help you and your clients meet your own objectives!</p>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Calendar.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4"> 
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Notes.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-4">
                                    <?php
                                    $image = CHtml::image("{$this->themeUrl}/images/Stats.png", 'optirep');
                                    echo CHtml::link($image, array('/optirep'));
                                    ?>
                                </div>
                                <div class="clearfix"></div>
