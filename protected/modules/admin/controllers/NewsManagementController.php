...
class NewsManagementController extends Controller
{
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax'])){
                    Yii::app()->user->setFlash('success', 'NewsManagement Deleted Successfully!!!');
	...
	{
            $model=new NewsManagement('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NewsManagement']))
			$model->attributes=$_GET['NewsManagement'];
	 ...
	 * @return NewsManagement the loaded model
	 ...
	 * @param NewsManagement $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='news-management-form')
		{
