...
$this->title='Export professional Datas';
...
<div class="col-lg-12 col-md-12">
    <div class="row">
        <?php echo CHtml::link('<i class="fa fa-plus"></i>&nbsp;&nbsp;Generate Data', array('/admin/exportDatas/create'), array('class' => 'btn btn-success pull-right')); ?>
    </div>
</div>
