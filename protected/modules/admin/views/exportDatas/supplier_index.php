...
<div class="col-lg-12 col-md-12">
    <div class="row">        
        <?php
        $isvisble = AdminIdentity::checkAccess_others(NULL, NULL,NULL, "generate_suppliers");  
        if($isvisble)
        {  
            echo CHtml::link('<i class="fa fa-plus"></i>&nbsp;&nbsp; Générer les données', array('/admin/exportDatas/generate_suppliers'), array('class' => 'btn btn-success pull-right'));
