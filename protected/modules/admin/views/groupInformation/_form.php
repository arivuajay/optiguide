    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="box-header">
                    <h3 class="box-title">Représentant</h3>
                </div>
            ...
            <div class="box-footer">
                <div class="form-group">
                    <div class="col-sm-0 col-sm-offset-2">
                        <?php echo CHtml::submitButton($model->isNewRecord ? 'Ajouter cette association' : 'Modifier cette association', array('class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary')); ?>
                    </div>
                </div>
            </div>
            <?php $this->endWidget(); ?>
...
<?php
$ajaxRegionUrl = Yii::app()->createUrl('/admin/groupInformation/getregions');
$ajaxCityUrl = Yii::app()->createUrl('/admin/groupInformation/getcities');
...
$(document).ready(function()
{
    ...
    $("#GroupInformation_country").change(function()
    {
        ...
        ({
            ...
            {             
                $("#GroupInformation_region").html(html);
            }
         });

    });
   
   $("#GroupInformation_region").change(function()
    {
        var id=$(this).val();
        var dataString = 'id='+ id;
        ...
        ({
            ...
            success: function(html)
            {             
                $("#GroupInformation_ID_VILLE").html(html);
            }
         });
