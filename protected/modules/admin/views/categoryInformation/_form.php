    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="box-header">
                    <h3 class="box-title">Association générale (section optionnelle) </h3>
                </div>
            ...
            <div class="box-footer">
                <div class="form-group">
                    <div class="col-sm-0 col-sm-offset-2">
                        <?php echo CHtml::submitButton($model->isNewRecord ? 'Ajouter une catégorie d\'association' : 'Modifier une catégorie d\'association', array('class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary')); ?>
                    </div>
                </div>
            </div>
            <?php $this->endWidget(); ?>
