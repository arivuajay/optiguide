            ...
            <div class="col-md-12">   
                ...
                <div class="box-footer">
                    <div class="form-group">
                        <div class="col-lg-12">
                            <?php
                            if (isset($model->rep_expiry_date) && Myclass::dateFormat($model->rep_expiry_date) >  date('Y-m-d')) {
                                echo CHtml::submitButton($pmodel->isNewRecord ? 'Submit' : 'Renew', array('class' => $pmodel->isNewRecord ? 'btn btn-success' : 'btn btn-primary', 'confirm' => 'This user has expiry date until ' . Myclass::dateFormat($model->rep_expiry_date) . ' Are you sure want to renew again?'));
                            } else {
                                echo CHtml::submitButton($pmodel->isNewRecord ? 'Submit' : 'Renew', array('class' => $pmodel->isNewRecord ? 'btn btn-success' : 'btn btn-primary'));
                            }
                            ?>
                        </div>
                    </div>
