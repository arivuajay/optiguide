            ...
            <section class="content">
                <div class="row">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        ...
                        'method' => 'get',
                        'action' => array('/admin/retailerDirectory/index/'),
                    ...
                    <div class="col-lg-12 col-md-12">
                        <p>
                            ...
                            (Regroupement, Store name, Head Office Name, Address, Postal code, Telephone, Fax, Email,  Website, Téléphone sans frais)
                        </p>
                    </div> 
                    <?php $this->endWidget(); ?>
                </div>
