            ...
            <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
                ...
                $this->widget('zii.widgets.CMenu', array(
                    ...
                    'items' => array(
                        ...
                        array('label' => Myclass::t('OG030', '', 'og'), 'url' => array('/optirep/professionalDirectory'), 'active' => $_controller == 'professionalDirectory' , 'visible'=>(Yii::app()->user->rep_role != "admin")),
                        array('label' => Myclass::t('OG032', '', 'og'), 'url' => array('/optirep/retailerDirectory'), 'active' => $_controller == 'retailerDirectory', 'visible'=>(Yii::app()->user->rep_role != "admin")),
