            ...
            'items' => array(
                ...
                */
                ...
                array('label' => '<i class="fa fa-file-excel-o"></i> <span> Export de données</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'submenuOptions' => array('class' => 'treeview-menu'),
                    'items' => array(      
                        array('label' => '<i class="fa fa-angle-double-right"></i> <span>Professionnel</span>', 'url' => array('/admin/exportDatas/index'), 'active' => ($_controller == 'exportDatas' && $_action=="index")),
                        array('label' => '<i class="fa fa-angle-double-right"></i> <span>Détaillant</span>', 'url' => array('/admin/exportDatas/retailerIndex'), 'active' => ($_controller == 'exportDatas' && $_action=="retailerIndex")),                       
                        array('label' => '<i class="fa fa-angle-double-right"></i> <span>Fournisseur</span>', 'url' => array('/admin/exportDatas/supplierIndex'), 'active' => ($_controller == 'exportDatas' && $_action=="supplierIndex")),                       
